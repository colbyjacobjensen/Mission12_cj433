...
// Heading section that introduces user to site
function Heading() {
  return (
    <div>
      <h1>March Madness School Info</h1>

      <p>March Madness is here!  Get the latest information about all the colleges in NCAA basketball.</p>
    </div>
  );
}
